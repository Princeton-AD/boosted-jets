...
def draw_deltaR_histograms(l1_reco_deltaR: np.array , jets_deltaR: np.array) -> None: 
    ...
    dR_hist_l1reco , jets_deltaR_hist , legend = draw_comparison_histogram(l1_reco_deltaR,jets_deltaR, dR_hist_l1reco ,jets_deltaR_hist , cut=None)
...
def draw_pt_histograms (bit_pt : np.array , cnn_pt: np.array) -> None: 
    ...
    bit_pt ,cnn_pt , legend = draw_comparison_histogram(bit_pt, cnn_pt, bit_pt_hist , cnn_pt_hist , cut=None)
...
def draw_pt_resolution_hist(bit_pt_resolution: np.array, cnn_pt_resolution: np.array): 
    ...
    bit_pt_resolution ,cnn_pt_resolution, legend = draw_comparison_histogram(bit_pt_resolution, cnn_pt_resolution, pt_resolution_l1 ,pt_resolution_cnn, cut=None)
...
def draw_eta_histograms(bit_eta : np.array, cnn_eta: np.array) :
    ...
    bit_eta_hist ,cnn_eta_hist, legend = draw_comparison_histogram(bit_eta, cnn_eta, bit_eta_hist, cnn_eta_hist, cut=None)
...
def draw_phi_histograms (bit_phi: np.array, cnn_phi: np.array): 
    ...
    bit_phi_hist ,cnn_phi_hist, legend = draw_comparison_histogram(bit_phi, cnn_phi, bit_phi_hist, cnn_phi_hist, cut=None)
